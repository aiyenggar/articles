...
\begin{document}
\title{Strategic Alliances in the New Economy}
\date{}
\maketitle
...
\pagestyle{fancy}
\fancyhf{}
\lhead{Strategic Alliances in the New Economy}
\rhead{\thepage}

\begin{center}
\textbf{Strategic Alliances in the New Economy}
\end{center}
...
\lstinputlisting{qe7/matchingEmbeddedAgency.py}
\end{singlespace}
