...
\cite{vonThunen1826} with rings of specialty
\cite{Hotelling1929} sellers agglomerate and minimize differentiation (linear transportation costs incentivizes this)

(Agglomeration) MAR \cite{Marshall1920} increasing returns to scale due to supplier, \cite{Arrow1962}, learning by doing, \cite{Romer1986} Knowledge returns increasing returns to scale
...
Disaggregation of the value chain into ever more specialized activities "Äúfine slicing"Äù \citep{Mudambi2008}
...
Puzzling empirical fact (Ashwin: Why don‚Äôt all factors that can affect a situation, actually do?)\par
