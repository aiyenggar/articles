...
\begin{document}
\title{Resource Allocation in Organizations: Behavioral Extensions}
\date{}
\maketitle
...
\pagestyle{fancy}
\fancyhf{}
\lhead{Resource Allocation in Organizations: Behavioral Extensions}
\rhead{\thepage}
...
\lstinputlisting{qe4/matchingEmbeddedAgency.py}
\end{singlespace}
