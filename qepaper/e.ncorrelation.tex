\begin{table}[htbp]\centering \caption{Correlation table for examiner only data set with dependent variable as non-self citations received \label{e.ncorrelation}}
