\begin{table}[htbp]\centering \caption{Correlation table for applicant and examiner citations  data set with DV as Non-Self Citations Received\label{ae.ncorrelation}}
\scriptsize
\singlespacing
