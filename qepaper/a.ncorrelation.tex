\begin{table}[htbp]\centering \caption{Correlation table for applicant citations with dependent variable as non-self citations received\label{a.ncorrelation}}
\scriptsize
\onehalfspacing
