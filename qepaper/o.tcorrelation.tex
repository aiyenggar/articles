\begin{table}[htbp]\centering \caption{Correlation table for other citations only data set with DV as Total Citations Received (distance calculated)\label{o.tcorrelation}}
\scriptsize
\singlespacing
