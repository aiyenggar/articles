...
\begin{hypothesis}
{Hypothesis 3: Firms with strong appropriation capabilities in munificent appropriability environments will maximize rents from GPTs by simultaneous explorative and exploitative behvior\\}
\end{hypothesis}
