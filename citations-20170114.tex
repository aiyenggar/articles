...
The results are in Table ~\ref{reg01}

\newpage
\begin{table}
\caption{Linear Regression Results}
\input{flows-2017-01-10/reg01.tex}
\end{table}

\newpage
\section{Negative Binomial Regression on All Data}
\begin{lstlisting}
xtnbreg cit_recd_total lncit_made_localinternal lncit_made_localexternal lncit_made_nonlocalinternal lncit_made_nonlocalexternal  lncit_made_other lnpatents lnpool d2002-d2012 if (year>=2001 & year<=2012), i(regionid) fe

note: 13214 groups (13214 obs) dropped because of only one obs per group
note: 8390 groups (24742 obs) dropped because of all zero outcomes

initial values not feasible
\end{lstlisting}

\newpage
\section{Negative Binomial Regression with Average Citations > 50}
\begin{lstlisting}
...
\end{lstlisting}
The results are in Table ~\ref{xtnbreg01}
\input{flows-2017-01-10/xtnbreg01}
...
\input{flows-2017-01-10/a1.tex}

\begin{table}
\caption{Regression Results}
\input{flows-2017-01-10/a2.tex}
\end{table}
