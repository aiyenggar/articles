...
\input{mci-assignment-images/1a.tex}
\begin{table}
\caption{}
\input{mci-assignment-images/1a1.tex}
\end{table}
...
\input{mci-assignment-images/1c.tex}
...
\begin{table}
\caption{}
\input{mci-assignment-images/1e.tex}
\end{table}
...
\input{mci-assignment-images/1hI.tex}
\label{1hI}
\end{table}
...
\input{mci-assignment-images/1hIIIa.tex}
\label{1hIIIa}
\end{table}
\newpage
\begin{table}
\caption{1985 effects of tools used on log wages, with occupation controls}
\input{mci-assignment-images/1hIIIb.tex}
\label{1hIIIb}
\end{table}
\end{center}
%\end{landscape}
